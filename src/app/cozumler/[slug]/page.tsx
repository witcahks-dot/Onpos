        ...
        <section className="py-12 sm:py-16 bg-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            <div>
              ...
              <p className="text-sm sm:text-base text-slate-600 mt-3 leading-relaxed font-medium">{solution.fullDesc}</p>
            </div>
            ...
            <div className="bg-blue-600 text-white p-8 rounded-3xl flex flex-col sm:flex-row items-center justify-between gap-6 shadow-xl shadow-blue-600/20">
              ...
              <button
                ...
                className="bg-slate-900 hover:bg-slate-800 text-white font-bold text-xs px-7 py-3.5 rounded-xl shadow-lg transition-all active:scale-95 whitespace-nowrap"
              >
                Hemen Teklif İste
              </button>
            </div>
