...
export default function ReferencesPage() {
  ...
  // District filter items with live counts
  const districtFilterItems: FilterItem[] = useMemo(() => {
    ...
    // Add extra city districts if city is selected
    if (selectedCity) {
  ...
  // Category filter items with live counts
  ...
  // Reset district filter when city changes & auto open district modal
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col font-sans selection:bg-red-600 selection:text-white">
      ...
      <main className="flex-1">
        ...
        {/* Page Hero Header (matching artipos screenshot style) */}
        ...
        {/* Interactive Turkey Map & Filters Section */}
        <section className="py-12 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            {/* CONTROL BAR: 2 SIDE-BY-SIDE POPUP MODAL BUTTONS (ARTIPOS POPUP STYLE!) */}
            <div className="bg-white p-5 rounded-3xl border border-slate-200 shadow-sm space-y-4">
              <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
                
                {/* 2 SIDE-BY-SIDE POPUP MODAL TRIGGER BUTTONS */}
                <div className="flex flex-col sm:flex-row items-center gap-3 w-full lg:w-auto">
                  
                  {/* Trigger Button 1: Semt / İlçe Filtrele (Opens District Modal!) */}
                  <button
                  ...
                  {/* Trigger Button 2: Sektör Filtrele (Opens Category Modal!) */}
                  <button
      ...
      {/* POPUP MODAL 1: SEMT / İLÇE SEÇİN MODAL (ARTIPOS POPUP SCREENSHOT STYLE!) */}
      <FilterModal
      ...
      {/* POPUP MODAL 2: SEKTÖR SEÇİN MODAL (ARTIPOS POPUP SCREENSHOT STYLE!) */}
      <FilterModal
