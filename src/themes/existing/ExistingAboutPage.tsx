...
export default function ExistingAboutPage() {
  ...
  const data = aboutPage || {
    ...
    storyContent: '2018 yılında kurulan şirketimiz, hantal geleneksel POS sistemlerinin yerine yüksek hızlı, bulut tabanlı ve Android işletim sistemli akıllı ödeme terminallerini getirmeyi misyon edinmiştir.',
