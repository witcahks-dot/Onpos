...
export default function ExistingServicesPage() {
              ...
              return (
                ...
                >
                  <div className="lg:col-span-7 space-y-4">
                    ...
                    <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">{service.shortDesc || service.fullDesc}</p>

                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-2 text-xs font-semibold text-slate-700">
                      {(service.benefits || service.features || []).map((f, i) => (
